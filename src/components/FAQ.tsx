...
const FAQ = () => {
  ...
  return (
    <section id="faq" className="py-16 md:py-24 bg-gradient-to-b from-blue-50 to-white">
      <div className="container mx-auto px-4">
          ...
          {faqs.map((faq, index) => (
            ...
            >
              ...
              >
                ...
                {openIndex === index ? (
                  <ChevronUp size={20} className="text-blue-800" />
                ) : (
        ...
        <div className="mt-12 bg-white p-8 rounded-xl shadow-md text-center">
          <h3 className="text-xl font-bold mb-4">{t('faq.contact.title')}</h3>
