  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-primary-50 to-white dark:from-gray-900 dark:to-gray-800 text-secondary-800 dark:text-gray-100 transition-colors duration-200">
      ...
      <button 
        ...
        className="fixed bottom-4 right-4 z-50 bg-primary-600 text-white w-20 h-20 rounded-full shadow-lg hover:bg-primary-700 transition-colors flex items-center justify-center"
      >
        {showChatbot ? (
